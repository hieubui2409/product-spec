...
# Pay with Stripe at checkout — Story PRD-CHECKOUT-E2-S1

## User Story

**As a** shopper, **I want** to pay with my card via Stripe at checkout, **so that** I can complete my order and
