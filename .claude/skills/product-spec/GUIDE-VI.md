...
### Ưu tiên 16 — Đảm bảo không bỏ sót điều quan trọng (lượt "Bộ nhớ" trong Validate)
...
### Ưu tiên 17 — Thu hồi những "ký ức" bạn đã bỏ lỡ trước đó (Reflect)
...
### Ưu tiên 18 — Bật lời nhắc bộ nhớ tự động (Stop hook tùy chọn)
