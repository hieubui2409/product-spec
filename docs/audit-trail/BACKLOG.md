...
**Trạng thái: ĐANG KHỞI CÔNG — P01·P02·P03·P04·P05·P06·P07·P08·P09·P12·P10a đã land + P13 draft** (2026-06-11/12). Đã đóng: LIB-5,6 (P01) ·
...
proposals (hỏi PO trước khi làm).** P10a (#2/#7/#12 SHIP-CRITICAL) landed 2026-06-12; P13 hiện vật rollout draft xong
(`docs/rollout/`, execution thuộc chủ kit). Còn lại (hoãn song song sau rollout): **P10b** (#6/#13/#14) · **P11**
(#8/#11/#15) · **#9**. Plan + hiện vật: `plans/260611-0050-po-field-audit-fix-waves/` (plan.md + 13 phase-*.md + reports).
...
- [~] **Wave MED/LOW ledger** — đã đóng P12: PS-19,20,22,24,25 + LIB-11(DEC),15,16 (docs/cleanup remainder). Còn lại các MED/LOW thuộc cụm P10/P11 (PO-facing surfaces + product-insight) sẽ xử theo phase tương ứng.
...
- [~] **Thông báo PO Cleanmatic** — hiện vật rollout ĐÃ SOẠN (P13 draft, bàn giao `docs/rollout/`): checklist nâng cấp + thông điệp mời 2.3.0 (6 nhóm mở khoá) + notice license AGPL (DRAFT, Q7=a, cần chủ kit rà pháp lý). Phần GỬI/tag/push + PO chạy `upgrade.sh` thuộc **chủ kit** (skill không tự thao tác). Cycle 3 giữ mở (P10b/P11/#9 hoãn song song sau rollout).
