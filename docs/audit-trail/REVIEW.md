...
- [ ] LIB-15 · CONSISTENCY · MED · `telemetry/GUIDE-VI.md:152,257` + `GUIDE-EN.md:152,257` — trỏ `.claude/rules/skill-workflow-routing.md` (đã xoá e52e077, ship cho PO) → repoint `data/skill-chains.yaml` (phát hiện khi cook P01; pre-existing doc-drift, gộp nhóm LIB-13 ở Phase 12 docs-cleanup).
