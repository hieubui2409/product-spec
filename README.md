...
> 🎮 **See the whole rig in action — [`showcase/index.html`](showcase/index.html):** a standalone,
> interactive tour of every feature of all four skills (dark, animated, bilingual EN/VI). No build
> step, no network calls — just open the file in any browser.
...
> 🎮 **Xem cả bộ chạy thực tế — [`showcase/index.html`](showcase/index.html):** một bản tham quan
> tương tác, tự chứa về **toàn bộ tính năng** của cả bốn skill (nền tối, có hoạt ảnh, song ngữ EN/VI).
> Không cần build, không gọi mạng — chỉ mở file bằng bất kỳ trình duyệt nào.
