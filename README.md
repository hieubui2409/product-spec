...
### 🎮&nbsp; [▶ Open the live interactive showcase](https://hieubui2409.github.io/product-spec/) &nbsp;🎮

Animated, **bilingual (EN/VI)** tour of every feature of all four skills — dark, interactive, right in your browser.
No build step, no network calls. *(Prefer local? Open [`showcase/index.html`](showcase/index.html).)*
...
### 🎮&nbsp; [▶ Mở showcase tương tác online](https://hieubui2409.github.io/product-spec/) &nbsp;🎮

Bản tham quan có hoạt ảnh, **song ngữ EN/VI** về toàn bộ tính năng của cả bốn skill — nền tối, tương tác, chạy thẳng trên trình duyệt.
Không cần build, không gọi mạng. *(Muốn chạy cục bộ? Mở [`showcase/index.html`](showcase/index.html).)*
